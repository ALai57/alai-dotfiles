;;; ~/.doom.d/fourclojure.el --- 4Clojure problems at your fingertips! -*- lexical-binding: t; -*-
;;
...
;; Homepage: https://github.com/andrew/fourclojure
...
(defun test-extract-test-cases ()
  (assert (equal
           ...
           (extract-4clojure-test-cases
            (with-temp-buffer
              (insert-file-contents "./fourclojure_test.html")
              (libxml-parse-html-region (point-min) (point-max)))))))
...
(defun test-extract-problem-info ()
  (let ((all-problems
         (dom->4clojure-problems
          (with-temp-buffer
            (insert-file-contents "./fourclojure_all_problems.html")
